...
// I could figure out how this problem could not be solved in linear time..
// It is like a brute force. Go through every element in the board and to check if it could be the the start of the 
// substring.
